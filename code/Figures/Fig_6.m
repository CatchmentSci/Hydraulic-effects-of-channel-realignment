% Initial code to reproduce Figure 6
...
legend(ax1, [h6 h3_0 h3 h5], ...
    {'Gauged flow discharge', 'Modelled flow discharge','Rating curve','Uncertainty bounds',}, ...
    'Position',[0.651063315466819 0.597263515061797 0.344642849585839 0.165476185934884],...
    'Box','off');
...
legend(ax2, {'Modeled flow discharge', 'Monitored river level'},...
    'Location','best',...
    'box', 'off');
